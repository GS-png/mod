...
public class Building : BaseSimObject, IEquatable<Building>, IComparable<Building>, ILoadable<BuildingData>
{
	...
	private void fillTiles()
	{
		...
		int num = current_tile.pos.x - asset.fundament.left;
		int num2 = current_tile.pos.y - asset.fundament.bottom;
	...
	{
		WorldTile tile = World.world.GetTile(current_tile.pos.x, current_tile.pos.y);
		if (tile == null)
		{
			tile = current_tile;
		}
