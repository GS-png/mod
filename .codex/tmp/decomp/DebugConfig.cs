...
public class DebugConfig : MonoBehaviour
{
	...
	public static void createTool(string pID, int pX = 80, int pY = -10, int pWidth = -1)
	{
		...
		DebugTool debugTool = UnityEngine.Object.Instantiate(PrefabLibrary.instance.debugTool, instance.transform);
		...
		debugTool.transform.localPosition = new Vector3(pX, pY);
		_pos_x += 128;
	}
