...
public class CancelButton : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (_timer < 1f)
		{
			...
			float y = (_going_down ? iTween.easeInOutCirc(0f, -90f, _timer) : ((!_going_up) ? iTween.easeInOutCirc(_rect.anchoredPosition.y, 0f, _timer) : iTween.easeInQuart(0f, 90f, _timer)));
			_rect.anchoredPosition = new Vector3(_rect.anchoredPosition.x, y);
		}
	}
}
