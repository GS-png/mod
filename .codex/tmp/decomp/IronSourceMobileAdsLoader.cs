...
public class IronSourceMobileAdsLoader : MonoBehaviour
{
	...
	internal void Start()
	{
		...
		{
			log("Initializing");
			com.unity3d.mediation.LevelPlayAdFormat[] adFormats = new com.unity3d.mediation.LevelPlayAdFormat[1] { com.unity3d.mediation.LevelPlayAdFormat.REWARDED };
			...
			Unity.Services.LevelPlay.LevelPlay.Init("unexpected_platform", null, adFormats);
