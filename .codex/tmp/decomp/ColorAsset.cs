...
public class ColorAsset : Asset
{
	...
	public void initColor()
	{
		if (!_initialized)
		{
			...
			Color color = _color_main_32;
			_color_border_inside_alpha_32 = new Color(color.r, color.g, color.b);
			_color_border_inside_alpha_32.a = 170;
			Color32 b = new Color32(30, 30, 30, byte.MaxValue);
			...
			k_color_1 = Color32.Lerp(k_color_0, b, 0.13f);
			k_color_2 = Color32.Lerp(k_color_0, b, 0.35000002f);
			k_color_3 = Color32.Lerp(k_color_0, b, 0.51f);
			k_color_4 = Color32.Lerp(k_color_0, b, 0.65999997f);
			k2_color_0 = _color_main_32;
			k2_color_0 = checkIfColorTooDark(k2_color_0);
			k2_color_1 = Color32.Lerp(k2_color_0, b, 0.13f);
			k2_color_2 = Color32.Lerp(k2_color_0, b, 0.35000002f);
			k2_color_3 = Color32.Lerp(k2_color_0, b, 0.51f);
			k2_color_4 = Color32.Lerp(k2_color_0, b, 0.65999997f);
		}
	}
