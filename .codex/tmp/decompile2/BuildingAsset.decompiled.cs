	...
	public void loadBuildingSprites()
	{
		...
		foreach (Sprite sprite in array)
		{
			...
			case "main":
			{
				...
				buildingAnimationData.list_main.Add(sprite);
			...
			case "disabled":
			{
				...
				buildingAnimationData.list_main_disabled.Add(sprite);
			...
			case "spawn":
			{
				...
				buildingAnimationData.list_spawn.Add(sprite);
			...
			case "ruin":
			{
				...
				buildingAnimationData.list_ruins.Add(sprite);
				break;
			}
			case "construction":
				building_sprites.construction = sprite;
			...
			case "special":
			{
				...
				buildingAnimationData.list_special.Add(sprite);
				break;
			}
			case "mini":
				building_sprites.map_icon = new BuildingMapIcon(sprite);
				break;
			}
			if (shadow)
			{
