...
if [[ "$TARGET_BASENAME" != "EraWheel" && ! -f "$TARGET_DIR/mod.json" ]]; then
  echo "Target must be an EraWheel mod folder or contain mod.json: $TARGET_DIR" >&2
  exit 1
fi
